...
export function Background() {
  ...
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden pointer-events-none select-none">
      ...
      <div className="absolute inset-0 bg-light-bg dark:bg-dark-bg transition-colors duration-700" />
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.08] dark:opacity-[0.04] text-foreground transition-all duration-500" viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M-100 150 C 300 250, 600 50, 1000 200 C 1200 250, 1500 150, 1600 170" stroke="currentColor" strokeWidth="1.2" strokeDasharray="3 3" />
        <path d="M-100 180 C 320 270, 580 80, 1020 220 C 1220 270, 1480 170, 1600 190" stroke="currentColor" strokeWidth="1.2" />
        <path d="M-100 210 C 340 290, 560 110, 1040 240 C 1240 290, 1460 190, 1600 210" stroke="currentColor" strokeWidth="1.2" strokeDasharray="3 3" />
        <path d="M-100 450 C 250 550, 650 350, 950 490 C 1150 550, 1450 450, 1600 470" stroke="currentColor" strokeWidth="1.2" />
        <path d="M-100 480 C 270 570, 630 380, 970 510 C 1170 570, 1430 480, 1600 500" stroke="currentColor" strokeWidth="1.2" strokeDasharray="5 5" />
        <path d="M-100 700 C 400 800, 700 600, 1100 750 C 1300 800, 1500 700, 1600 720" stroke="currentColor" strokeWidth="1.2" />
      </svg>
      ...
      <div className="absolute top-12 left-12 opacity-[0.15] dark:opacity-[0.08] text-foreground transition-opacity">
        <svg width="60" height="60" viewBox="0 0 60 60" fill="currentColor">
          ...
          <circle cx="5" cy="20" r="1.5" /><circle cx="20" cy="20" r="1.5" /><circle cx="35" cy="20" r="1.5" /><circle cx="50" cy="20" r="1.5" />
          <circle cx="5" cy="35" r="1.5" /><circle cx="20" cy="35" r="1.5" /><circle cx="35" cy="35" r="1.5" /><circle cx="50" cy="35" r="1.5" />
          <circle cx="5" cy="50" r="1.5" /><circle cx="20" cy="50" r="1.5" /><circle cx="35" cy="50" r="1.5" /><circle cx="50" cy="50" r="1.5" />
        </svg>
      </div>
